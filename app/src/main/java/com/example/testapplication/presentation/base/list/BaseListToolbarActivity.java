...
/**
 * Created by Anatoliy Mizyakin on 18.10.2018.
 */
public abstract class BaseListToolbarActivity<M, P extends BaseListPresenter> extends BaseToolbarActivity<P> implements BaseListView<M, P>, BaseListInterface<M> {
