...
import com.example.testapplication.presentation.base.view.fragment.BaseToolbarFragment;

import java.util.List;

public abstract class BaseListToolbarFragment<M, P extends BaseListPresenter> extends BaseToolbarFragment<P> implements BaseListView<M, P>, BaseListInterface<M> {
